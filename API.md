...
| 특정 상품 수량 변경 | PATCH  | /api/cart/items/:productId/ | <pre>{<br>&nbsp;&nbsp;"quantity": 15<br>}</pre> | <pre>{<br>&nbsp;&nbsp;"id": 1,<br>&nbsp;&nbsp;"product_id": 1,<br>&nbsp;&nbsp;"quantity": 15<br>}</pre>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 특정 상품 삭제      | DELETE | /api/cart/items/:productId/ | X                                               | X                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
