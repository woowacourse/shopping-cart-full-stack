...
export const postOrderCheckCouponDiscount = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const discountAmount = await couponService.getDisCountAmount(req.body.selectedCouponId, DUMMY_USER_ID);
