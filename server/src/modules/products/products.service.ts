...
export const createProduct = (productRequest: Partial<ProductRequest>) => {
    ...
    const missingFields = getMissingFields(productRequest, requiredFields as unknown as string[]);
...
export const deleteProduct = (id: number) => {
    ...
    if (!product) {
        throw new ServiceError('RESOURCE_NOT_FOUND', 'id에 해당하는 상품이 존재하지 않습니다.');
    }
